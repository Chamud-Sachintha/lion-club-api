...
Route::middleware('authToken')->post('activate-club-user', [ClubUserController::class, 'enableClubUserByCode']);
...
Route::middleware('authToken')->post('get-club-report-data', [GovernerController::class, 'getClubReportData']);
